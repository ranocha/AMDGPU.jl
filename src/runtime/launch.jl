...
function launch_kernel!(
    ...
    @log_start(:launch_kernel!, (;entry=kernel.sym, signal=get_handle(signal), queue=get_handle(queue)), nothing)
    ...
    @log_finish(:launch_kernel!, (;entry=kernel.sym, signal=get_handle(signal), queue=get_handle(queue)), nothing)
end
